...
# Davis has more balls hit to the right and Correa more to the left. Davis also has more home runs. 

# I couldn't import the statcast package for my version of R so I couldn't 
# complete the next exercises. Instead, I made the following plots, beginning to 
# work on my final project

judge <- scrape_statcast_savant(start_date = "2017-06-09", 
                                end_date = "2017-07-09", 
                                playerid = 592450,
                                player_type = "batter")
judge_bip <- judge %>%
...
## ----spray_chart, warning=FALSE, fig.cap="Spray chart of balls in play hit by Carlos Correa in May, 2017."----
spray_chart(judge_bip, aes(x = hc_x, y = -hc_y, color = events)) + 
  geom_point() + 
  scale_color_grey()
